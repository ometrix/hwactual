...
const FeatureList = [
  {
    ...
    description: (
      <>
          We support you with the deployment and implementation of small to medium sized network infrastructures. We do the planning, equipment quoting and configuration.
      </>
    ),
  },
  {
